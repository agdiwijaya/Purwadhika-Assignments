    ...
    def menu_4():
        ...
        while status == "True":
            ...
            try:
                ...
                if len(data) <=0:
                    print("Data barang kosong, tidak ada yang bisa dihapus")
                    status = 'False'
                else:
                    if inputhapus == 1:
                        data.clear()
                        ...
                        while statushapusbarang == True:
                            ...
                            if baranghapus in data.keys():
                                ...
                                hapusnull = input('Apakah anda masih ingin menghapus barang? (Y/N): ').upper()
...
personal_info = {"UserID":['fajarsetiawan12',],
"Password" : ['Fajar_420'],
